        ...
        <div className="feature-window">
            <div className="overlap-group-wrapper">
                <div className="overlap-group">
                    ...
                    <a href="/"><img className="screenshot-3" alt="Screenshot" src="/Icons/Screenshot_2023-10-12_134932-removebg-preview 1.png" /></a>
                    <img className="user" alt="User" src="/Icons/user_6911682 1.png" />
                </div>
            </div>
        </div>
    );
